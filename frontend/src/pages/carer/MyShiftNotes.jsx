          ...
          const shiftNotes = [
            {
              ...
              content: "Assisted with morning routine. Personal hygiene care completed.",
              category: "Daily Care",
          ...
          const allNotes = [
            {
              _id: "6612note123",
              shiftId: "shift1",
              content: "Morning care completed. Resident participated in activities.",
              category: "Daily Care",
              createdAt: new Date(Date.now() - 3600000).toISOString(),
              updatedAt: new Date(Date.now() - 3600000).toISOString(),
            ...
            },
            {
              _id: "6612note124",
              shiftId: "shift2",
              content: "Evening routine completed. Good appetite at dinner.",
              category: "Daily Care",
